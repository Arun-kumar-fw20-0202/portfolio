...
function Contact(){
    ...
    return(
        <div id="contact" className="pages">
            ...
            <div className="links">
                <a href="https://github.com/Arun-kumar-fw20-0202"><i className="fa fa-github"></i>GitHub</a>
                <a href="https://www.linkedin.com/in/arun-kumar-655989200/"><i className="fa fa-linkedin"></i>Linkdin</a>
